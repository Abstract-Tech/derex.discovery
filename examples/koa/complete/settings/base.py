...
OAUTH_OIDC_ISSUER = "http://discovery-koa-complete.localhost/oauth2"
...
ECOMMERCE_PUBLIC_URL_ROOT = "http://ecommerce.discovery-koa-complete.localhost"
ECOMMERCE_API_URL = "http://ecommerce.discovery-koa-complete.localhost/api/v2"

COURSE_CATALOG_API_URL = "http://discovery.discovery-koa-complete.localhost"
