...
OAUTH_OIDC_ISSUER = "http://discovery-ironwood-complete.localhost/oauth2"
...
ECOMMERCE_PUBLIC_URL_ROOT = "http://ecommerce.discovery-ironwood-complete.localhost"
ECOMMERCE_API_URL = (
    "http://ecommerce.discovery-ironwood-complete.localhost.derex/api/v2"
)

COURSE_CATALOG_API_URL = "http://discovery.discovery-ironwood-complete.localhost"
